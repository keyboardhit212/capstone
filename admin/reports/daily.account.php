...
<html>
	...
	<body>
		...
		<?php
			foreach($report->account_report("daily", $date) as $reports) {
				...
				echo "<span id='employer'>".'Student Achievers'."</span><span id='company'>".$reports['student_achiever']."</span><br/><br/><hr/>";
