		...
		<div id="container">
			<div id="header">
				...
				<div id="headerNavigation">
					<a href="index.php?page=notification"><div id="notificationDiv" class="navRow"><span><h6 id='notifStat'>56</h6>Notifications</span></div></a>
			...
			<div id="body">
				...
				<div id="filters">
					<div id="sorting">
						...
						<a><button type="button" onclick="location.href='search.php?keyword=<?php echo $keyword ?>&skill=<?php echo $skill ?>'" class="left">A - Z</button></a><a><button type="button" onclick="location.href='search.php?keyword=<?php echo $keyword ?>&skill=<?php echo $skill ?>&sort=DESC'" class="right">Z - A</button></a><br/><br/>
				...
				<div id="results">
					<div id="banner"><img src="../images/resultslogan.png"/><span id="job"><?php echo $keyword." ".(($skill != '' ) ? ' - '.$skill : '') ?></span><span id="percentage"><?php /*echo $search->employer_results($profession->get_profession_id($keyword),$skill)['result']." / ".$search->employer_results($profession->get_profession_id($keyword),$skill)['total']*/ ?> <!--Matches!--></span></div>
					<div id="innerResults">
						<?php
							foreach($search->employer_search($keyword,$skill,$_SESSION['status'],$sort) as $stud) {
								echo "<div class='row'>
											<div id='jobName'><a href='detail.php?page=about&id=".$stud['student_id']."'><span id='jobText'>".$user->get_full_name($stud['student_id'])."</span></a></div>
											<div id='companyName'><a href=''><span id='companyText'>".$industry->get_industry_name($student->get_industry($stud['student_id']))." - ".$profession->get_profession_name($student->get_profession($stud['student_id']))."</span></a></div>
											<div id='description'>".$resume->get_objective($stud['student_id'])."</div>
										</div>";
							}
						?>
