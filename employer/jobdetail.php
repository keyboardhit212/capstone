...
<html>
	...
	<body>
		...
		<div id="companyDetails">
			<div id="pic">
				<img src="../images/ellipse.png" id="ellipse"/><div id="logo"><img src="<?php echo $company->get_pic($_SESSION['user_id']); ?>"/></div><br/>
				<a href=""><?php echo $company->get_link($_SESSION['user_id']); ?></a>
			</div>
			<span id="companyName">Hammyster Production</span>
			<span id="companyDescription"><?php echo $company->get_description($_SESSION['user_id']); ?></span>
			<span id="companyAddress"><?php echo $company->get_address($_SESSION['user_id']); ?>
		</div>
		<div id="jobDetail">
			<span id="profession"><?php echo $profession->get_profession_name($job->get_profession_id($job_id)); ?></span>
			<span id="industry"><?php echo $industry->get_industry_name($job->get_industry_id($job_id));?></span><br/>
			<span id="status">Status:<span><?php echo ($job->get_status($job_id) == 1) ? 'Open' : 'Closed'; ?></span></span>
			<a href="processes/process.job.close.php?job_id=<?php echo $job_id; ?>"><div id="closeJob"><span>Close Job</span></div></a>
		</div>
